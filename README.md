...
- ~~You buying from mouser / any shop that is not aliexpress really will be a better experience for you~~ - ~~warranty, faster shipping, safer shipping~~ I did never hear complains about the aliexpress guy not accepting warranty claims, also shipping from aliexpress improved a lot in the recent year, ~~better packaging~~ Well the watchy v2 one from aliexpress is already assembled, the screen is already in place and it's hard to do it by yourself, ~~better more quality components (battery, case & strap)~~ or not really, you can get a watchy v3 which gets hot and can start a fire.
