...
- In my experience, the screen ghosts in extreme temperatures - arround 0 or 30°C it's bad - maybe I'm not sure about the cold part. But, from what I had heard recently the seller started using a newer generation of screens. (SQFMI says it's "the faster" screen, not really ). The only difference is that it blinks less in full refreshes, still cool. Some users suggested that it withstands extreme temperatures better, but the documentation for those screens doesn't support this claim.
  - Newer generation screens have been reported to withstand temperatures as high as 38° and as low as -10°C before experiencing ***significantly*** worse ghosting and other degradations
